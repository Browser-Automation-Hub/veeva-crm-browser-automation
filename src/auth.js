/**
 * auth.js — Authentication handler for Veeva CRM (Veeva Commercial Cloud)
...
const BASE_URL = process.env.VEEVA_CRM_URL || 'https://your-tenant.veeva.com/ui/#login';
const USERNAME = process.env.VEEVA_CRM_USERNAME;
const PASSWORD = process.env.VEEVA_CRM_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set VEEVA_CRM_USERNAME and VEEVA_CRM_PASSWORD in .env`);
  }

  console.log('Logging in to Veeva CRM (Veeva Commercial Cloud)...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
